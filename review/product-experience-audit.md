...
- Projetos consumidores criados antes do installer v0.9.0-rc.1 precisam adicionar Runtime local, CDL local e conformidade CDL manualmente ou reinicializar com cuidado.
