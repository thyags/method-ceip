...
- Se o usuário pedir uma nova tela, dashboard, formulário ou interface premium, o Codex deve usar `product-experience/` para definir experiência, CDL local, conformidade CDL, layout, interação, acessibilidade e score visual antes de frontend.
